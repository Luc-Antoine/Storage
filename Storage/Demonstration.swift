...
class Demonstration {
    ...
    func french() {
        ...
        dataBase.insert(Feature(id: 10, name: "Espagne", count: 1, itemId: 4, nameFeatureId: 4, featureId: 10))
        dataBase.insert(Feature(id: 11, name: "Banco de Espana", count: 1, itemId: 4, nameFeatureId: 5, featureId: 11))
        dataBase.insert(Feature(id: 12, name: "1979", count: 1, itemId: 4, nameFeatureId: 6, featureId: 12))
        
        dataBase.insert(Feature(id: 13, name: "Martinique", count: 1, itemId: 5, nameFeatureId: 4, featureId: 13))
        dataBase.insert(Feature(id: 14, name: "Banque de la Martinique", count: 1, itemId: 5, nameFeatureId: 5, featureId: 14))
        dataBase.insert(Feature(id: 15, name: "1943", count: 1, itemId: 5, nameFeatureId: 6, featureId: 15))
        
        dataBase.insert(Feature(id: 16, name: "Autriche", count: 1, itemId: 6, nameFeatureId: 4, featureId: 16))
        dataBase.insert(Feature(id: 17, name: "Oberosterreich", count: 1, itemId: 6, nameFeatureId: 5, featureId: 17))
        dataBase.insert(Feature(id: 18, name: "1921", count: 1, itemId: 6, nameFeatureId: 6, featureId: 18))
    ...
    func english() {
        ...
        dataBase.insert(Feature(id: 7, name: "Chrisitan Jacq", count: 1, itemId: 3, nameFeatureId: 1, featureId: 7))
        dataBase.insert(Feature(id: 8, name: "History", count: 1, itemId: 3, nameFeatureId: 2, featureId: 8))
        dataBase.insert(Feature(id: 9, name: "2019", count: 1, itemId: 3, nameFeatureId: 3, featureId: 9))
        ...
        dataBase.insert(Feature(id: 10, name: "Spain", count: 1, itemId: 4, nameFeatureId: 4, featureId: 10))
        dataBase.insert(Feature(id: 11, name: "Banco de Espana", count: 1, itemId: 4, nameFeatureId: 5, featureId: 11))
        dataBase.insert(Feature(id: 12, name: "1979", count: 1, itemId: 4, nameFeatureId: 6, featureId: 12))
        ...
        dataBase.insert(Feature(id: 16, name: "Austria", count: 1, itemId: 6, nameFeatureId: 4, featureId: 16))
        dataBase.insert(Feature(id: 17, name: "Oberosterreich", count: 1, itemId: 6, nameFeatureId: 5, featureId: 17))
        dataBase.insert(Feature(id: 18, name: "1921", count: 1, itemId: 6, nameFeatureId: 6, featureId: 18))
